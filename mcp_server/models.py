...
class CertificateParameters(BaseModel):
    cert_type: str = Field(..., description='cert_type', examples=['Registration'])
    company_name: str = Field(
        ..., description='company_name', examples=['Solution Pollution BMS']
    )
    reg_no: str = Field(
        ..., description='reg_no', examples=['IT/Registration/0477/2019-20']
    )
    sector: str = Field(..., description='sector', examples=['IT'])
...
class CocerCertificatePostRequest(BaseModel):
...
class CocerCertificatePostResponse(BaseModel):
...
class CocerCertificatePostResponse1(BaseModel):
...
class CocerCertificatePostResponse2(BaseModel):
...
class CocerCertificatePostResponse3(BaseModel):
...
class CocerCertificatePostResponse4(BaseModel):
...
class CocerCertificatePostResponse5(BaseModel):
...
class CocerCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class RfcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class RfcerCertificatePostResponse(BaseModel):
...
class RfcerCertificatePostResponse1(BaseModel):
...
class RfcerCertificatePostResponse2(BaseModel):
...
class RfcerCertificatePostResponse3(BaseModel):
...
class RfcerCertificatePostResponse4(BaseModel):
...
class RfcerCertificatePostResponse5(BaseModel):
...
class RfcerCertificatePostResponse6(BaseModel):
